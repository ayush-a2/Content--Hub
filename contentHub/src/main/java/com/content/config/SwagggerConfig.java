...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("ContentHub Application : Backend Course",
				"This project is developed by Ayush", "1.0", "Terms of Service",
				new Contact("Ayush", "https://ayush-a2.github.io", "ayush8583@gmail.com"),
